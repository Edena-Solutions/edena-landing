...
faqs:
    - question: "¿Qué es el modelo 233?"
      answer: "Es una declaración informativa anual que presentan las guarderías y centros de educación infantil autorizados ante la Agencia Tributaria. En ella comunican qué menores de tres años han estado matriculados, qué meses completos han asistido y qué importes han pagado sus familias. Con esa información, la AEAT calcula el incremento de la deducción por maternidad —el conocido cheque guardería, de hasta 1.000 euros anuales— sin que las familias tengan que justificar los gastos."
    - question: "¿Qué guarderías están obligadas a presentar el modelo 233?"
      answer: "Los centros de educación infantil autorizados y, tras los últimos criterios judiciales, también guarderías con autorización o licencia para la actividad de custodia de menores. La presentación no es opcional si quieres que tus familias accedan a la deducción: si el centro no declara, las madres no pueden aplicar el incremento. En la práctica, presentar el 233 correctamente es un servicio que las familias esperan de su centro."
    - question: "¿Cuándo se presenta el modelo 233?"
      answer: "En enero de cada año, respecto al ejercicio anterior. Es un plazo corto y cae justo después de las vacaciones de Navidad, por lo que llegar a enero con los datos ya ordenados —altas, bajas, meses completos e importes por niño— marca la diferencia entre un trámite de una mañana y semanas de reconstruir información."
    - question: "¿Qué datos exige el modelo 233?"
      answer: "Por cada menor: sus datos identificativos, los de sus progenitores o tutores con NIF, los meses completos de asistencia al centro y los importes anuales pagados, distinguiendo el gasto subvencionado si lo hay, además de los datos de autorización del centro. El error más común son los meses incompletos mal contados y los importes que no cuadran con lo realmente cobrado, algo que ocurre cuando los pagos se llevan en hojas de cálculo."
    - question: "¿Qué pasa si el modelo 233 tiene errores?"
      answer: "Los errores se trasladan directamente a las familias: la AEAT puede denegar o reclamar la deducción a una madre porque los datos del centro no cuadran, con el conflicto que eso genera. Además, las declaraciones informativas incorrectas pueden acarrear requerimientos y sanciones al centro. La mejor prevención es que matrícula, asistencia y cobros salgan del mismo sistema, de forma que lo declarado coincida siempre con lo facturado."
---

<strong>Modelo 233 para guarderías y escuelas infantiles: guía práctica</strong>
...
<strong>Qué es el modelo 233 y por qué importa a las familias</strong>
...
<strong>Quién está obligado a presentarlo</strong>
...
<strong>Qué datos exige la AEAT</strong>
...
<strong>El problema de enero: reconstruir en vez de consultar</strong>
...
<strong>Cómo llegar a enero con el trabajo hecho</strong>

<br>

La solución no es un truco para enero, sino la forma de trabajar el resto del año: que matrícula, asistencia y cobros salgan del mismo sistema. Cuando el alta de cada niño, sus meses de asistencia y sus recibos cobrados viven en la misma plataforma, el 233 deja de ser una reconstrucción y pasa a ser una consulta: los importes declarados coinciden con lo facturado porque son el mismo dato. Un <a href="/nurseries">programa de gestión para escuelas infantiles</a> que integre expedientes y <a href="/finance">facturación escolar automatizada</a> convierte el trámite de enero en una exportación ordenada para tu asesoría.
...
<strong>Contexto en España: más control y familias más atentas</strong>
