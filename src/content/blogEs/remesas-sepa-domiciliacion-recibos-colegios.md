...
tags:
    [
        "remesas SEPA colegios",
        "domiciliación recibos escolares",
        "mandato SEPA",
...
faqs:
    - question: "¿Qué es una remesa SEPA y por qué la usan los colegios?"
      answer: "Una remesa SEPA es un fichero que agrupa varias órdenes de cobro domiciliado para enviarlas al banco de una vez. Los colegios y guarderías la usan para cobrar cuotas mensuales a cientos de familias sin tramitar recibo por recibo. En lugar de cobros sueltos, se genera un único envío con todos los adeudos del periodo."
    - question: "¿Qué diferencia hay entre CORE y B2B en SEPA?"
      answer: "El esquema CORE es el habitual para adeudos a particulares (familias) y permite la devolución por parte del deudor en un plazo amplio. El esquema B2B es para operaciones entre empresas, con plazos de devolución distintos. Para el cobro de cuotas a familias, lo normal es el esquema CORE; confirma siempre con tu banco y tu asesoría qué esquema aplica a cada caso."
    - question: "¿Por qué se devuelven los recibos domiciliados?"
      answer: "Las causas más comunes son: IBAN incorrecto o desactualizado, falta de fondos, mandato no firmado o caducado, y datos del titular que no coinciden. Una parte importante de las devoluciones no son impagos reales, sino errores de datos que un sistema con mandatos digitales y validación de IBAN evita antes de generar la remesa."
    - question: "¿Es obligatorio tener el mandato firmado por la familia?"
      answer: "Sí. Para domiciliar un recibo necesitas un mandato SEPA válido firmado por el titular de la cuenta, con la información requerida y conservado de forma que puedas demostrarlo si hay una devolución por mandato inexistente. Gestionar los mandatos en papel suelto es la principal causa de problemas en una auditoría de devoluciones."
    - question: "¿Edena genera las remesas SEPA automáticamente?"
      answer: "El módulo de facturación de Edena gestiona la facturación recurrente y los recibos de las familias dentro de la plataforma, con análisis de impagos. El alcance exacto de generación de ficheros y conciliación depende del módulo contratado y de la configuración con tu entidad bancaria; pregúntalo en la demo para confirmar qué circuito queda cubierto sin trabajo manual."
---

<strong>Remesas SEPA en colegios: domiciliación de recibos sin errores</strong>
...
<strong>Qué es una remesa SEPA y cómo encaja en un centro</strong>
...
<strong>El mandato SEPA: el documento que lo sostiene todo</strong>
...
<strong>CORE vs B2B: usa el esquema correcto</strong>
...
<strong>Por qué se devuelven los recibos (y cuántos son evitables)</strong>
...
<strong>El coste oculto de las devoluciones</strong>
...
<strong>Cómo automatizar la domiciliación bien</strong>
...
<strong>Edena y la facturación recurrente de cuotas</strong>
...
<strong>Contexto en España: cuotas, impagos y tesorería</strong>
