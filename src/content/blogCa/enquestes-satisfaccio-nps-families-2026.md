...
tags:
    [
        "enquestes satisfacció famílies",
        "NPS col·legis",
        "satisfacció famílies escola",
        "retenció d'alumnes",
        "feedback centre educatiu",
        "Edena",
    ]
author: "ENA by Edena"
...
relatedPosts:
    ...
    - colaboracio-families-centre-educatiu
    - marketing-educatiu-digital-estrategies
faqs:
    - question: "Què és el NPS en un col·legi i com es calcula?"
      answer: "El NPS (Net Promoter Score) mesura quant recomanarien les famílies el centre, amb una pregunta de 0 a 10. Es calcula restant el percentatge de detractors (0-6) al de promotors (9-10). És un indicador simple i comparable que resumeix la salut de la relació amb les famílies en un sol número, fàcil de seguir curs a curs."
    - question: "Cada quant convé enquestar les famílies?"
      answer: "Depèn de l'objectiu. Un NPS general una o dues vegades l'any dóna la foto de fons. Enquestes puntuals després de moments clau —la matrícula, una activitat, el primer trimestre— capten l'experiència en calent. L'important és no saturar: poques preguntes, en el moment oportú, i demostrar que les respostes s'utilitzen, o les famílies deixaran de contestar."
    - question: "Per què mesurar la satisfacció si ja parlem amb les famílies?"
      answer: "Parlar amb les famílies capta opinions de qui alça la veu; mesurar capta també les silencioses, que són les que se'n van sense avisar. Una família descontenta rarament es queixa: simplement no renova. L'enquesta detecta aquest descontentament latent a temps, quan encara es pot actuar, en lloc de descobrir-lo quan ja ha causat baixa."
    - question: "Com es relaciona la satisfacció amb la retenció d'alumnes?"
      answer: "La satisfacció és el millor predictor de la renovació. Una família satisfeta renova i recomana; una insatisfeta es planteja alternatives. Mesurar la satisfacció permet anticipar baixes i actuar sobre les causes abans de la campanya de renovació, quan encara hi ha marge per reconduir la relació."
    - question: "Les enquestes han de ser anònimes?"
      answer: "Depèn de l'objectiu. L'anonimat afavoreix la sinceritat i és ideal per al clima general. Però per poder actuar sobre un cas concret convé poder identificar qui ho desitgi. Una bona estratègia combina ambdós: NPS general anònim per a la tendència i canals identificats per a qui vulgui que el centre respongui a la seva situació."
---

<strong>Enquestes de satisfacció i NPS en col·legis: mesurar abans de perdre famílies</strong>
...
<strong>La família descontenta no es queixa: se'n va</strong>
...
<strong>Què és el NPS i per què funciona</strong>
...
<strong>Mesurar en els moments que importen</strong>
...
<strong>Poques preguntes, en el moment just</strong>
...
<strong>El que no es tanca, no es torna a contestar</strong>
...
<strong>De la satisfacció a la retenció</strong>
...
<strong>Context a Espanya: competència i reputació</strong>
