...
<strong>D'on surt l'impagament que podem atacar amb automatització</strong>
...
<strong>Pilars pràctics per reduir la morositat</strong>

<br>

1. **Definir què es cobra, quan i amb quina periodicitat**: Alinea cicles a la realitat de les famílies, evita sorpreses, documenta excepcions. Els centres amb menús clars i anticipació solen notar menys disputes.
2. **Recurrència i recordatoris esglaonats, no murs de missatges**: Un recordatori a temps, un altre a X dies, escalat; segmentar els que ja van abonar parcialment o famílies amb acord.
3. **Canal i to: email, notificació, SMS si escau, sense contradir-se**: Coherència entre el que llegeix el tutor i el que veu secretaria.
4. **Historial i conciliació visibles**: Menys “crec que va pagar”, més traces. Això afegeix pau a la taula i evita reclaus.
5. **Regles, no impro**: A qui s'escala, quan es deriva a direcció, quan s'ofereix fraccionament, quan es talla un servei accessori segons política, tot escrit, perquè el programari executi, no reemplaci el criteri, però tampoc depengui de memòria.
6. **Medició mensual de mora**: Taxa, antiguitat, import, grups, serveis, per discutir amb dades, no amb sensacions.
...
<strong>Cas simplificat: guarderia amb quotes mensuals i servei de menjar</strong>
...
<strong>Quan un col·legi concertat afronta una altra capa: claredat, concurrència, missatges a escala</strong>
...
<strong>Què exigir tècnicament al teu proveïdor de plataforma</strong>
...
<strong>Errors comuns en “automatitzar”</strong>
...
<strong>Pla mínim de 30 dies: què fixar abans de tocar les famílies</strong>
...
<strong>Equilibri humà: automatització i diàleg</strong>
...
<strong>Benchmark de morositat a col·legis privats (Espanya)</strong>
...
<strong>Plantilla de comunicació a famílies (extracte)</strong>
