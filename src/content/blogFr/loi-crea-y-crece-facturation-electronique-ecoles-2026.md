...
faqs:
    ...
    - question: "Quand entre-t-elle en vigueur pour mon établissement ?"
      answer: "Le calendrier dépend du développement réglementaire et du chiffre d'affaires annuel de chaque entreprise : celles au chiffre d'affaires le plus élevé entrent avant les PME et les indépendants. Ne mémorisez pas une date : confirmez avec votre expert-comptable le délai précis qui s'applique à votre établissement, car le règlement fixe des paliers différents selon le volume."
    - question: "Quelle différence entre Verifactu et la facturation électronique de Crea y Crece ?"
      answer: "Verifactu est le système d'envoi et d'enregistrement de la facturation à l'administration fiscale avec un logiciel répondant aux exigences anti-fraude. La facture électronique de Crea y Crece est l'obligation d'émettre et de recevoir des factures en format structuré entre entreprises. Ce sont des réglementations distinctes qui coexistent : l'une concerne la façon dont vous enregistrez, l'autre le format et le canal des factures B2B."
    - question: "Ai-je besoin d'un nouveau logiciel ou celui que j'ai suffit-il ?"
      answer: "Cela dépend si votre système peut émettre et recevoir des factures en format structuré, signaler les statuts et conserver l'historique. Demandez à votre fournisseur si sa feuille de route inclut le format exigé et dans quel délai. Un Excel et un PDF par e-mail ne répondent pas à l'exigence de facture électronique structurée."
    - question: "Que se passe-t-il si je ne m'adapte pas à temps ?"
      answer: "Émettre ou recevoir des factures hors du format et des délais exigés expose l'établissement à des sanctions et, surtout, à des frictions opérationnelles : fournisseurs qui n'acceptent pas votre facture, retards de paiement et écarts avec le cabinet comptable. S'adapter en amont évite le goulot d'étranglement du dernier moment."
---

<strong>Loi Crea y Crece : facturation électronique B2B pour écoles et académies</strong>
...
<strong>Ce qu'est vraiment la facture électronique de Crea y Crece</strong>
...
<strong>Qui est concerné au sein d'un établissement scolaire</strong>
...
<strong>Calendrier : paliers selon le chiffre d'affaires</strong>
...
<strong>Crea y Crece et Verifactu ne sont pas la même chose</strong>
...
<strong>Le risque d'être en retard</strong>
...
<strong>Comment se préparer en 2026 étape par étape</strong>
...
<strong>Contexte en Espagne : retards de paiement et traçabilité</strong>
