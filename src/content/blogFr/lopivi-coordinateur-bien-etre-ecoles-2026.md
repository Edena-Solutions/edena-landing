...
tags:
    [
        "LOPIVI",
        "coordinateur de bien-être",
        "protection de l'enfance établissements",
        "protocoles écoles",
        "conformité éducation",
        "Edena",
    ]
author: "ENA by Edena"
...
faqs:
    - question: "Quels établissements doivent avoir un coordinateur de bien-être ?"
      answer: "La LOPIVI exige une fonction de coordination du bien-être et de la protection dans les établissements scolaires où étudient des mineurs. La concrétisation de la fonction, son profil et ses missions dépendent du développement régional, il convient donc de confirmer les exigences exactes dans votre région avec votre administration éducative."
    - question: "La LOPIVI oblige-t-elle à avoir un logiciel précis ?"
      answer: "Non. La LOPIVI n'impose pas d'outil technologique. Ce qu'elle exige, ce sont des protocoles, de la formation, un enregistrement des actions et de la traçabilité. Un logiciel de gestion ne remplace ni le coordinateur ni les protocoles, mais il aide à documenter les communications, conserver les registres avec contrôle d'accès et démontrer la traçabilité en cas d'inspection ou de situation."
    - question: "Comment la LOPIVI se relie-t-elle à la protection des données ?"
      answer: "Les registres de bien-être traitent des données particulièrement sensibles concernant des mineurs. Cela oblige à combiner la conformité LOPIVI avec le RGPD : base légale, minimisation, contrôle d'accès par rôle et conservation appropriée. Un dossier numérique avec des permissions par profil est plus sûr que des dossiers partagés ou des e-mails épars."
    - question: "À quelle fréquence faut-il revoir les protocoles ?"
      answer: "Les protocoles ne sont pas un document que l'on rédige une fois et que l'on archive. Il convient de les revoir au moins au début de chaque année et après tout incident pertinent, en mettant à jour contacts, responsables et étapes. La traçabilité de qui a revu quoi et quand fait partie de la conformité."
    - question: "Le coordinateur de bien-être peut-il s'appuyer sur la communication avec les familles ?"
      answer: "Oui. Une grande partie de la prévention passe par des canaux de communication clairs avec les familles et par le fait que les avis critiques arrivent et soient confirmés. Une plateforme avec communication traçable aide à ce que les circulaires de protocole, les consentements et les avis importants ne se perdent pas dans un e-mail non lu."
---

<strong>LOPIVI dans les établissements : coordinateur de bien-être et gestion numérique</strong>
...
<strong>Ce qu'est la LOPIVI et pourquoi elle concerne votre établissement</strong>
...
<strong>Le rôle du coordinateur de bien-être</strong>
...
<strong>Ce que la LOPIVI n'est pas : aucun logiciel ne respecte la loi à votre place</strong>
...
<strong>Traçabilité et enregistrement : le cœur de la conformité</strong>
...
<strong>LOPIVI et RGPD : deux exigences qui vont de pair</strong>
...
<strong>La communication avec les familles comme outil de prévention</strong>
...
<strong>Comment soutenir le coordinateur avec Edena</strong>
...
<strong>Contexte en Espagne : du papier au protocole vivant</strong>
