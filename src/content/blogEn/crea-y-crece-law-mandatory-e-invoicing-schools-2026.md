...
faqs:
    ...
    - question: "When does it come into force for my center?"
      answer: "The timeline depends on the regulatory development and each company's annual turnover: those with higher turnover enter before SMEs and the self-employed. Don't memorize a date: confirm the specific deadline that applies to your center with your accountant, because the regulation sets different tiers by volume."
    - question: "What's the difference between Verifactu and Crea y Crece e-invoicing?"
      answer: "Verifactu is the system for sending and recording invoicing to the Tax Agency with software that meets anti-fraud requirements. The Crea y Crece e-invoice is the obligation to issue and receive invoices in a structured format between companies. They are different rules that coexist: one affects how you record, the other the format and channel of B2B invoices."
    - question: "Do I need new software or is what I have enough?"
      answer: "It depends on whether your system can issue and receive invoices in a structured format, report statuses, and keep the history. Ask your provider whether its roadmap includes the required format and on what timeline. An Excel file and a PDF by email do not meet the structured e-invoice requirement."
    - question: "What happens if I don't adapt in time?"
      answer: "Issuing or receiving invoices outside the required format and deadlines exposes the center to penalties and, above all, to operational friction: suppliers who won't accept your invoice, payment delays, and mismatches with your accountant. Adapting early avoids the bottleneck of doing it at the last minute."
---

<strong>Crea y Crece Law: B2B E-Invoicing for Schools and Academies</strong>
...
<strong>What Crea y Crece e-invoicing really is</strong>
...
<strong>Who it affects within an educational center</strong>
...
<strong>Timeline: tiers by turnover</strong>
...
<strong>Crea y Crece and Verifactu are not the same</strong>
...
<strong>The risk of being late</strong>
...
<strong>How to prepare in 2026 step by step</strong>
...
<strong>Context in Spain: late payment and traceability</strong>
