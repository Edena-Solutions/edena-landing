...
tags:
    ...
    - "school NPS"
    - "family satisfaction school"
    - "student retention"
    - "educational center feedback"
    - "Edena"
author: "ENA by Edena"
...
faqs:
    - question: "What is NPS in a school and how is it calculated?"
      answer: "NPS (Net Promoter Score) measures how much families would recommend the center, with a 0-to-10 question. It's calculated by subtracting the percentage of detractors (0-6) from that of promoters (9-10). It's a simple, comparable indicator that summarizes the health of the relationship with families in a single number, easy to track year over year."
    - question: "How often should families be surveyed?"
      answer: "It depends on the goal. A general NPS once or twice a year gives the background picture. One-off surveys after key moments —enrollment, an activity, the first term— capture the experience while it's fresh. The important thing is not to oversaturate: few questions, at the right moment, and demonstrating that responses are used, or families will stop answering."
    - question: "Why measure satisfaction if we already talk to families?"
      answer: "Talking to families captures the opinions of those who speak up; measuring also captures the silent ones, who are the ones who leave without warning. A dissatisfied family rarely complains: they simply don't renew. The survey detects that latent dissatisfaction in time, when you can still act, instead of discovering it when it has already caused a withdrawal."
    - question: "How does satisfaction relate to student retention?"
      answer: "Satisfaction is the best predictor of renewal. A satisfied family renews and recommends; a dissatisfied one considers alternatives. Measuring satisfaction makes it possible to anticipate withdrawals and act on the causes before the renewal campaign, when there's still room to redirect the relationship."
    - question: "Should surveys be anonymous?"
      answer: "It depends on the goal. Anonymity favors honesty and is ideal for the general climate. But to be able to act on a specific case, it's useful to be able to identify those who wish. A good strategy combines both: anonymous general NPS for the trend and identified channels for those who want the center to respond to their situation."
---

<strong>Satisfaction Surveys and NPS in Schools: Measure Before Losing Families</strong>
...
<strong>The dissatisfied family doesn't complain: it leaves</strong>
...
<strong>What NPS is and why it works</strong>
...
<strong>Measure at the moments that matter</strong>
...
<strong>Few questions, at the right moment</strong>
...
<strong>What isn't closed won't be answered again</strong>
...
<strong>From satisfaction to retention</strong>
...
<strong>Context in Spain: competition and reputation</strong>
