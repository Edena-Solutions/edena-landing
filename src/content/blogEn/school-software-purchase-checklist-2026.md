...
tags:
    ...
    - "educational software checklist"
    - "school ERP criteria"
    - "buy school platform"
...
<strong>Before searching: define your real problem</strong>
...
<strong>Module checklist: essentials vs. what you can add later</strong>

<br>

<strong>Essentials in any center:</strong>
...
<strong>Assess according to the center:</strong>
...
<strong>Questions for the demo: what the provider does not always show on its own initiative</strong>
...
<strong>How to calculate three-year TCO</strong>
...
<strong>Alarm signs at a supplier</strong><br>

- You cannot demonstrate the functionality with your data in the first session.
...
<strong>The recommended decision process</strong>
...
<strong>Numbered checklist for purchasing committee</strong>

<br>

1. **Define three measured pains:** Inventory processes in hours or euros (collections, registration, communication). Without a starting metric there is no criterion for the pilot's success.
2. **List essentials:** Collections, file, family portal and user roles. The rest is desirable, not blocking the first phase.
3. **Request a demo with real data:** Five fictitious but plausible families and a complete cycle of receipts, not just a catalog of screens.
4. **Calculate 36-month TCO per student:** License, migration, training, integrations and internal coordination hours.
5. **Pilot 8-12 weeks with written cut-off criteria:** What KPI must be met to continue (delinquency, admin hours, conversion).
6. **Validate data and support commissioning contract in September:** Confirm DPA, SLA and response at enrollment peak.
7. **Agree on a migration plan and internal manager:** A person with a management mandate, not just external IT.

<br>

<strong>Demo scorecard (0-5 per criteria)</strong>
