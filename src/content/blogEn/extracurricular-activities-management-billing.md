...
tags:
    ...
    - "online extracurricular enrollment"
    - "activity billing"
    - "school activity places"
...
faqs:
    - question: "Why do extracurriculars generate so much administrative work?"
      answer: "Because each activity has its own fee, place limit, schedules, and often its own monitor, and enrollments arrive scattered by paper, email, and WhatsApp. Without a system that centralizes enrollment, places, and billing per activity, administration ends up with dozens of parallel lists to balance by hand."
    - question: "How are limited places and waiting lists managed?"
      answer: "With an enrollment system that controls each activity's capacity and generates an automatic waiting list when full. So when a place becomes free, you know who it corresponds to without arguments about who asked first, which is where conflicts arise when the list lives in an Excel."
    - question: "Can each activity be billed separately but on a single receipt?"
      answer: "Yes, and it's ideal. Each activity has its fee, but the family receives a single coherent receipt with all the month's concepts. That simplifies collection, reconciliation, and communication, versus charging each extracurricular through a different channel."
    - question: "Are extracurriculars managed by the school or an external company?"
      answer: "It depends on the center: sometimes the school manages them, sometimes an external company or the parents' association. In any case, having enrollment, places, and billing in a common system prevents information from living in silos. If a third party provides the activity, traceability of enrollment and charges remains key for the center."
    - question: "Does Edena manage extracurriculars?"
      answer: "Edena, depending on the contracted modules, manages activities with enrollment, place control, and associated billing, plus family communication and self-management, all in the same platform. The specific scope depends on configuration; it's best to confirm in the demo to see which enrollment and billing circuit is covered."
---

<strong>Extracurricular Activities Management: Enrollment and Billing</strong>
...
<strong>The problem: one activity, a thousand channels</strong>
...
<strong>Limited places and waiting lists without conflicts</strong>
...
<strong>Billing per activity, single receipt</strong>
...
<strong>Communication: let the family know what's happening</strong>
...
<strong>Own or third-party extracurriculars: traceability matters equally</strong>
...
<strong>What Edena brings to extracurriculars</strong>
...
<strong>Context in Spain: extracurriculars as a service and as recruitment</strong>
