...
faqs:
    - question: "Which centers are required to have a wellbeing coordinator?"
      answer: "LOPIVI requires a wellbeing and protection coordination role in educational centers attended by minors. The specifics of the role, its profile, and its functions depend on regional development, so it is advisable to confirm the exact requirements in your region with your education authority."
    - question: "Does LOPIVI require specific software?"
      answer: "No. LOPIVI does not impose a technological tool. What it requires is protocols, training, recording of actions, and traceability. Management software does not replace the coordinator or the protocols, but it helps document communications, keep records with access control, and demonstrate traceability in case of inspection or a case."
    - question: "How does LOPIVI relate to data protection?"
      answer: "Wellbeing records handle especially sensitive data on minors. That requires combining LOPIVI compliance with GDPR: legal basis, minimization, role-based access control, and appropriate retention. A digital record with per-profile permissions is safer than shared folders or loose emails."
    - question: "How often should protocols be reviewed?"
      answer: "Protocols are not a document you write once and file away. It is advisable to review them at least at the start of each year and after any relevant incident, updating contacts, responsible parties, and steps. Traceability of who reviewed what and when is part of compliance."
    - question: "Can the wellbeing coordinator rely on family communication?"
      answer: "Yes. Much of prevention runs through clear communication channels with families and through critical notices reaching and being confirmed. A platform with traceable communication helps ensure protocol circulars, consents, and important notices are not lost in an unread email."
---

<strong>LOPIVI in Schools: Wellbeing Coordinator and Digital Management</strong>
...
<strong>What LOPIVI is and why it affects your center</strong>
...
<strong>The role of the wellbeing coordinator</strong>
...
<strong>What LOPIVI is not: no software complies with the law for you</strong>
...
<strong>Traceability and recording: the heart of compliance</strong>
...
<strong>LOPIVI and GDPR: two requirements that go together</strong>
...
<strong>Family communication as a prevention tool</strong>
...
<strong>How to support the coordinator with Edena</strong>
...
<strong>Context in Spain: from paper to a living protocol</strong>
