...
<strong>Angle: academic and financial design</strong>
...
<strong>What is an educational dashboard in practice</strong>
...
<strong>Evolution by concept:</strong>
...
<strong>Occupancy by stage:</strong>
...
<strong>Results by group or subject:</strong>
...
<strong>Quarterly evolution:</strong>
...
<strong>Administration/secretariat:</strong>
...
<strong>Academic coordination:</strong>
...
Some metrics must be viewed daily (collections for the day, alerts); others, weekly or monthly (retention, occupation, financial summary). An educational dashboard can combine real-time indicators with others that are updated every night or week.<br>
...
<strong>Common errors when using an educational dashboard</strong>
...
1. List the 5–10 recurring decisions that require data (collection, retention, occupancy, absenteeism).
2. Assign 1–2 indicators per decision and check that the system can generate them.
3. Define at least one view for management and one for administration.
4. Configure at least one alert (non-payment, occupancy, absences) with the person responsible and review frequency.
5. Set a time in the week or month to review the dashboard and take action.
6. Review each course if the indicators are still useful or others need to be added.

<br>

<strong>How many dashboards do I need?</strong>
...
1. An educational dashboard groups key collection, retention, occupancy and attendance indicators.
2. Metrics must be adapted by audience (management, administration, coordination).
3. Including alerts (non-payment, absenteeism, occupancy) increases the value of the dashboard.
4. Fewer well-chosen indicators are better than many unfocused displays.
5. Reviewing the dashboard periodically and acting on the data closes the circle.
...
<strong>Academic vs operational metrics</strong>
...
<strong>Consolidation in groups</strong>
...
<strong>Case study (Spain)</strong><br>
