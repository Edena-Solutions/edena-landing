export default {
    ...
    navigation: {
        academics: "Académico",
        students: "Estudiantes",
        studentsDescription: "Gestiona registros, asistencia y rendimiento de estudiantes.",
        classes: "Clases",
        classesDescription: "Programa y organiza clases para tu escuela.",
        administration: "Administración",
        dashboard: "Panel",
        dashboardDescription: "Visualiza el rendimiento de tu escuela de un vistazo.",
        finance: "Finanzas",
        financeDescription: "Gestiona finanzas escolares, cuotas y presupuestos.",
        pricing: "Precios",
        faqs: "Preguntas Frecuentes",
    },
    conclusion: {
        title: "El futuro de la gestión escolar comienza aquí",
        description:
